...
- [Agentic Workflow Library Design](./agentic-workflow-library.md) - Core DSL design
- [System Architecture](./system-architecture.md) - Three-tier architecture
- [Agentic Workflow Theory](../ai-theory/agentic-workflow-theory.md) - Formal framework

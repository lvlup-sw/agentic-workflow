...
1. [RED] Write test: `ContextSourceModel_IsAbstractRecord_CannotInstantiate`
   - File: `src/Strategos.Generators.Tests/Models/ContextSourceModelTests.cs`
...
2. [GREEN] Implement abstract record
   - File: `src/Strategos.Generators/Models/ContextSourceModel.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Models/StateContextSourceModelTests.cs`
   - Expected failure: Type does not exist
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Models/RetrievalContextSourceModelTests.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Models/StepModelContextTests.cs`
...
2. [GREEN] Extend StepModel
   - File: `src/Strategos.Generators/Models/StepModel.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Helpers/ContextModelExtractorTests.cs`
   - Expected failure: Type does not exist
   - Run: `dotnet test --filter "FullyQualifiedName~ContextModelExtractorTests"` - MUST FAIL

2. [GREEN] Implement extractor
   - File: `src/Strategos.Generators/Helpers/ContextModelExtractor.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Emitters/ContextAssemblerEmitterTests.cs`
...
2. [GREEN] Implement emitter
   - File: `src/Strategos.Generators/Emitters/ContextAssemblerEmitter.cs`
...
1. [RED] Write test: `IContextAssembler_Interface_ExistsWithCorrectSignature`
   - File: `src/Strategos.Agents.Tests/Abstractions/IContextAssemblerTests.cs`
...
2. [GREEN] Implement interface
   - File: `src/Strategos.Agents/Abstractions/IContextAssembler.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Agents.Tests/Models/ContextSegmentTests.cs`
   - Expected failure: Types do not exist
   - Run: `dotnet test --filter "FullyQualifiedName~ContextSegmentTests"` - MUST FAIL

2. [GREEN] Implement segment types
   - File: `src/Strategos.Agents/Models/ContextSegment.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Agents.Tests/Models/RetrievalResultTests.cs`
   - Expected failure: Type does not exist
   - Run: `dotnet test --filter "FullyQualifiedName~RetrievalResultTests"` - MUST FAIL

2. [GREEN] Implement record
   - File: `src/Strategos.Agents/Models/RetrievalResult.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Agents.Tests/Models/AssembledContextTests.cs`
   - Expected failure: Type does not exist
   - Run: `dotnet test --filter "FullyQualifiedName~AssembledContextTests"` - MUST FAIL

2. [GREEN] Implement class
   - File: `src/Strategos.Agents/Models/AssembledContext.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Agents.Tests/Models/AssembledContextBuilderTests.cs`
   - Expected failure: Type does not exist
   - Run: `dotnet test --filter "FullyQualifiedName~AssembledContextBuilderTests"` - MUST FAIL

2. [GREEN] Implement builder
   - File: `src/Strategos.Agents/Models/AssembledContextBuilder.cs`
...
1. [RED] Write test: `IRagCollection_IsMarkerInterface_HasNoMembers`
   - File: `src/Strategos.Rag.Tests/Abstractions/IRagCollectionTests.cs`
   - Expected failure: Interface does not exist
   - Run: `dotnet test --filter "FullyQualifiedName~IRagCollectionTests"` - MUST FAIL

2. [GREEN] Implement interface
   - File: `src/Strategos.Rag/Abstractions/IRagCollection.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Rag.Tests/Abstractions/TypedVectorSearchAdapterTests.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Rag.Tests/Extensions/RagServiceExtensionsTests.cs`
...
2. [GREEN] Implement extension
   - File: `src/Strategos.Rag/Extensions/RagServiceExtensions.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Emitters/Saga/SagaFailureHandlerComponentEmitterTests.cs`
...
2. [GREEN] Fix any missing functionality
   - File: `src/Strategos.Generators/Emitters/Saga/SagaFailureHandlerComponentEmitter.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Tests/Events/WorkflowFailedEventTests.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Emitters/Saga/StepLevelFailureEmitterTests.cs`
...
2. [GREEN] Implement step-level failure
   - File: `src/Strategos.Generators/Emitters/Saga/SagaStepHandlersEmitter.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/GeneratorContextIntegrationTests.cs`
...
2. [GREEN] Wire emitter into generator
   - File: `src/Strategos.Generators/WorkflowSourceGenerator.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Generators.Tests/Emitters/Saga/SagaStepHandlersContextTests.cs`
...
1. [RED] Write tests:
   ...
   - File: `src/Strategos.Tests/Integration/ContextIntegrationTests.cs`

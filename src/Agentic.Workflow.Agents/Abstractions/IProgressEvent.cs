// =============================================================================
// <copyright file="IProgressEvent.cs" company="Levelup Software">
...
/// <summary>
/// Base interface for all progress events in the workflow event sourcing system.
/// </summary>
/// <remarks>
/// <para>
/// All progress events implement this interface to ensure they can be stored in

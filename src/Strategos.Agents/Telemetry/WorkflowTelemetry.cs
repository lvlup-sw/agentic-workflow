...
namespace Strategos.Agents.Telemetry;
...
/// workflow step handlers generated by the Strategos source generators.
/// </para>
/// <para>
...
public static class WorkflowTelemetry
{
    ...
    /// </summary>
    public const string SourceName = "Strategos.Steps";

    /// <summary>
    /// The name of the workflow step Meter for metrics.
    /// </summary>
    public const string MeterName = "Strategos.Steps";

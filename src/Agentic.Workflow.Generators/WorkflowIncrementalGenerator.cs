...
{
    private const string WorkflowAttributeFullName = "Agentic.Workflow.Attributes.WorkflowAttribute";
    ...
    private static string WrapMermaidAsCSharp(WorkflowModel model, string mermaidContent)
    {
        ...
        sb.AppendLine("/// </summary>");
        sb.AppendLine("[System.CodeDom.Compiler.GeneratedCode(\"Agentic.Workflow.Generators\", \"1.0.0\")]");

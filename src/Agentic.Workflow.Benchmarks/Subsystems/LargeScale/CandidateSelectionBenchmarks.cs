...
public class CandidateSelectionBenchmarks
{
    ...
    public void GlobalSetup()
    {
        ...
        this.selector = new ThompsonSamplingAgentSelector(beliefStore, randomSeed: 42);
    ...
    public async Task<Agentic.Workflow.Primitives.Result<AgentSelection>> SelectAgent()
    {

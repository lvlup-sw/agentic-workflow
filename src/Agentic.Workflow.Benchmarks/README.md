...
Performance benchmarking suite for Agentic.Workflow, built on [BenchmarkDotNet](https://benchmarkdotnet.org/).
...
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --filter *Ledger*

# Run all selection/Thompson sampling benchmarks
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --filter *ThompsonSampling*

# Run specific benchmark class
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --filter *AgentSelectionBenchmarks*

# Run specific benchmark method
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --filter *AgentSelectionBenchmarks.SelectAgent*

# Multiple patterns (OR logic)
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --filter *Ledger* *Cache*
```
...
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --exporters json

# Export to Markdown (for documentation)
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --exporters markdown

# Export to both
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --exporters json markdown

# Custom artifacts directory
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --artifacts ./my-results
```
...
namespace Agentic.Workflow.Benchmarks.Subsystems.YourSubsystem;
...
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --job short

# Dry run (validate setup without running)
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --job dry

# List all available benchmarks
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --list flat

# Memory profiling only
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --memory

# Run with detailed statistics
dotnet run -c Release --project src/Agentic.Workflow.Benchmarks -- --statisticalTest 5%
```

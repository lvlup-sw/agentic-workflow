...
Infrastructure implementations for Agentic.Workflow including Thompson Sampling agent selection, loop detection, and budget enforcement.
...
```csharp
services.AddAgenticWorkflowInfrastructure(options =>
{
